...
angular.module('bullboard').controller('AdsListCtrl', ['$scope', '$meteor', function ($scope, $stateParams) {
    $scope.ads = [{author:"Author",desc:"Lorum ipsum dolor sit amit, lorum ipsum dolor sit amit, lorum ipsum dolor sit amit",price:1500,date:"13.10.2016",img:"",checked:true}];
    $scope.query = "";
